...
<div class ="footer">
	<div class="footer-button" align="center">
		...
		<button class="btn btn-info" value="print" onclick="window.print()">Print Page</button>	
...
<div id ="bug" class="report-error" style="display: none">
 	<form class="modal-content animate" action="#" method="post">
		<div class="container" style="background: #3c6262; box-shadow: 0px -1px 14px 2px #bbbbbb;">
		  ...
		  <input  type="text" style="width:100%;margin-top:5px" id="err_url" name="err_url" placeholder="${pageContext.request.contextPath}" disabled="disabled">
